function e2m1(){
    ...
    let flBtn = new Button("________________________", 250, 20, 520, 202, 0xffffff, 0x212121, 20);
    flBtn.Draw();

    let slBtn = new Button("________________________", 250, 20, 700, 226, 0xffffff, 0x212121, 20);
    slBtn.Draw();
    ...
    slBtn.OnClick = () => {
        if(selectedT == 2){
            let tmp = new Button("unterschiedlicher", 250, 20, 700, 226, 0xffffff, 0x212121, 20);
            tmp.Draw();
            selectedT = 0;
            let tmp2 = new Button("a", 300, 100, 700, 500, 0x212121, 0x212121, 20);
            tmp2.Draw();
            dones++;
        }
    };
