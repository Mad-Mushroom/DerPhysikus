...
function e2m6(){
    ...
    G_LEVEL = 206;
    E_header();
    let answer1Btn = new SpriteButton('https://raw.githubusercontent.com/Mad-Mushroom/DerPhysikus/main/game/js/res/e2m3_background.png', 200, 200, 100, 300, 0xffffff, 0x313131);
    answer1Btn.Draw();

    let answer2Btn = new SpriteButton('https://raw.githubusercontent.com/Mad-Mushroom/DerPhysikus/main/game/js/res/e2m3_background.png', 200, 200, 100, 550, 0xffffff, 0x313131);
    answer2Btn.Draw();

    let answer3Btn = new SpriteButton('https://raw.githubusercontent.com/Mad-Mushroom/DerPhysikus/main/game/js/res/e2m3_background.png', 200, 200, 700, 300, 0xffffff, 0x313131);
    answer3Btn.Draw();

    let answer4Btn = new SpriteButton('https://raw.githubusercontent.com/Mad-Mushroom/DerPhysikus/main/game/js/res/e2m3_background.png', 200, 200, 700, 550, 0xffffff, 0x313131);
    answer4Btn.Draw();
    ...
    answer4Btn.OnClick = () => {
        G_Points--;
        E_header();
        let tmp = new Button('', 200, 200, 700, 550, 0xffffff, 0xff0000);
        tmp.Draw();
    }
