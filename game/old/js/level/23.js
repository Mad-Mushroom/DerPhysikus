function e2m3(){
    ...
    let fTextObj = new PIXI.Text("QUEST: Versuche genau 9,810 Joule an (potenzielle) Energie zu bekommen.\nZur Auswahl stehen dir folgende Möglichkeiten (Formel: Eₚₒₜ = Fɢ * h -> Eₚₒₜ = m * g * h):",{fontFamily : 'Arial', fontSize: 20, fill : 0xffffff, align : 'center'});
    fTextObj.x = 10;
    fTextObj.y = 100;
